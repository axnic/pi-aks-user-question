...
| ------------ | ---------------------------------------------- |
| `form`       | Form lifecycle and TUI rendering (`src/form/`) |
| `schema`     | Tool parameter schema (`src/schema.ts`)        |
| `validation` | Text input validation (`src/validation.ts`)    |
| `docs`       | Documentation                                  |
| `deps`       | Dependency updates                             |
| `tooling`    | Dev tooling (mise, trunk, commitlint, etc.)    |
